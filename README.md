# React Native Tor branch with hidden service
...
```shell script
npm i --save https://github.com/alex-iphone/react-native-tor.git
// for ios builds
npx pod-install
```
...
1. Install package
```sh
npm install https://github.com/alex-iphone/react-native-tor.git
```
or
```shell script
yarn add https://github.com/alex-iphone/react-native-tor.git
```
2. Link libs
